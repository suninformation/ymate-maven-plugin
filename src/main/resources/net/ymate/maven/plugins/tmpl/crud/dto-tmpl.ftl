...
import ${app.packageName}.bean.${prefix}${api.name?cap_first}Bean;<#if apidocs>
 ...
 *
 * ${prefix}${api.name?cap_first}DTO generated By CrudMojo on ${.now?string("yyyy/MM/dd a HH:mm")}
 *
