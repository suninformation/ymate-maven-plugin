...
import ${app.packageName}.bean.${prefix}${api.name?cap_first}UpdateBean;<#if apidocs>
 ...
 *
 * ${prefix}${api.name?cap_first}UpdateDTO generated By CrudMojo on ${.now?string("yyyy/MM/dd a HH:mm")}
 *
