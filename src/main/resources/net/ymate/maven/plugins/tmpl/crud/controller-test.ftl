 ...
 *
 * ${prefix}${api.name?cap_first}ControllerTest generated By CrudMojo on ${.now?string("yyyy/MM/dd HH:mm")}
 *
...
@EnableBeanProxy
@EnableDevMode
public class ${prefix}${api.name?cap_first}ControllerTest {
    ...
    public void testCreate() throws Exception {
        ...
        <#elseif primaryKey?? && primaryKey.config?? && (primaryKey.config.create?? && primaryKey.config.create.enabled || primaryKey.config.createOrUpdate?? && primaryKey.config.createOrUpdate.enabled)>
    ...
    public void testUpdate() throws Exception {
        ...
        <#elseif primaryKey?? && primaryKey.config?? && (primaryKey.config.update?? && primaryKey.config.update.enabled || primaryKey.config.createOrUpdate?? && primaryKey.config.createOrUpdate.enabled)>
                <@buildParameter primaryKey/>
        </#if>
